    ...
    public partial class Form1 : Form
    {
        ...
        private void btBrowse1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                w1.WaveFile = file1;
                w1.Refresh();
                lbInfo1.Text = file1.NSamples + " samples - "+ file1.SampleRate+ " Hz - "+ file1.NChannels + " channels";
                cbChan1.Items.Clear();
        ...
        private void btBrowse2_Click(object sender, EventArgs e)
        {
            ...
            w2.WaveFile = file2;
            w2.Refresh();
            lbInfo2.Text = file2.NSamples + " samples - " + file2.SampleRate + " Hz - " + file2.NChannels + " channels";
            cbChan2.Items.Clear();
        ...
        public void NormalizeWaves(int iMethod)
        {
            ...
            else if(iMethod==1){//Attenuate to lowest
                if (Peak1 > Peak2)
                    ratio1 = Peak2 / Peak1;
                else
                    ratio2 = Peak1 / Peak2;
